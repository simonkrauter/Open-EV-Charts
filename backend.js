...
var db = {
  ...
  getChartParams: function(chartConfig = null) {
    ...
    // metric
    {
      ...
      param.title = "Metric";
      param.allOptions = {};
      param.allOptions[this.metrics.ratioElectric] = "Relative EV Sales";
      param.allOptions[this.metrics.salesElectric] = "Absolute EV Sales";
      param.allOptions[this.metrics.shareElectric] = "EV Market Split";
      param.allOptions[this.metrics.salesAll] = "All Cars Sales";
      param.allOptions[this.metrics.ratioElectricWithinCompanyOrBrand] = "EV Ratio within Company/Brand";
      param.allOptions[this.metrics.shareAll] = "All Cars Market Split";
